...
- 《JavaScript 高级程序设计（第 4 版）》是当前补全 JavaScript 基础笔记的重要参考资料之一，书中以 ES2019 为时间节点，覆盖到 ECMA-262 第 10 版。引用书中版本内容时，应按这一标准时间点理解，并结合后续最新 ES 标准版本与现代运行环境校正。

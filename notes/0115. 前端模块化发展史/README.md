...
- [1. 🎯 本节内容](#1--本节内容)
- [2. 🫧 评价](#2--评价)
- [3. 🤔 为什么要记录前端的模块化发展史？](#3--为什么要记录前端的模块化发展史)
- [4. 🤔 模块化的出现，核心是为了解决什么问题？](#4--模块化的出现核心是为了解决什么问题)
- [5. 🤔 模块化是什么？](#5--模块化是什么)
- [6. 🤔 前端常见的模块化标准有哪些？](#6--前端常见的模块化标准有哪些)
- [7. 🤔 前端模块化发展史分为哪四个阶段？](#7--前端模块化发展史分为哪四个阶段)
  - [7.1. ⌛️ 第一阶段 - JS 诞生](#71-️-第一阶段---js-诞生)
  - [7.2. ⌛️ 第二阶段 - ajax 出现](#72-️-第二阶段---ajax-出现)
  - [7.3. ⌛️ 第三阶段 - V8、NodeJS 出现](#73-️-第三阶段---v8nodejs-出现)
  - [7.4. ⌛️ 第四阶段](#74-️-第四阶段)
- [8. 🤔 CommonJS 规范在 nodejs 环境和浏览器环境有什么差异？](#8--commonjs-规范在-nodejs-环境和浏览器环境有什么差异)
  - [8.1. nodejs 环境](#81-nodejs-环境)
  - [8.2. 浏览器环境](#82-浏览器环境)
- [9. 🤔 AMD 和 CMD 是什么？为什么会出现？](#9--amd-和-cmd-是什么为什么会出现)
- [10. 🔗 引用](#10--引用)
...
1. 根据模块路径找到本地文件，读取文件内容
2. 将文件代码包装到函数中执行，返回 `module.exports` 的值

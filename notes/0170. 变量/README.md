...
- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. 围绕“变量”展开的核心知识点都有哪些？](#3-围绕变量展开的核心知识点都有哪些)
  - [3.1. 核心概念](#31-核心概念)
  - [3.2. 自动回收机制](#32-自动回收机制)
  - [3.3. 语法糖](#33-语法糖)
  - [3.4. 定义变量](#34-定义变量)
    - [`var`](#var)
    - [`let`](#let)
...
- [13. 面试题 1 - 请谈谈 `var`、`let`、`const`](#13-面试题-1---请谈谈-varletconst)
- [14. 面试题 2 - 下面的代码输出的结果是什么？](#14-面试题-2---下面的代码输出的结果是什么)
- [15. 面试题 3 - 下面的代码输出的结果是什么？](#15-面试题-3---下面的代码输出的结果是什么)
- [16. 面试题 4 - 请谈谈什么是变量声明提升？](#16-面试题-4---请谈谈什么是变量声明提升)
...
- [27. demos.11 - `var` - 无块级作用域](#27-demos11---var---无块级作用域)
- [28. demos.12 - `let` - 有块级作用域](#28-demos12---let---有块级作用域)
- [29. demos.13 - `let` - 使用 `var`、`let` 定义 `for` 循环的循环变量（经典的闭包陷阱问题）](#29-demos13---let---使用-varlet-定义-for-循环的循环变量经典的闭包陷阱问题)
...
- [34. demos.18 - `let` - `for` 循环的参数和循环体处于不同的作用域](#34-demos18---let---for-循环的参数和循环体处于不同的作用域)
- [35. demos.19 - `let` - `let` 出现之前的经典历史问题](#35-demos19---let---let-出现之前的经典历史问题)
...
## 29. demos.13 - `let` - 使用 `var`、`let` 定义 `for` 循环的循环变量（经典的闭包陷阱问题）
...
## 34. demos.18 - `let` - `for` 循环的参数和循环体处于不同的作用域
...
## 35. demos.19 - `let` - `let` 出现之前的经典历史问题

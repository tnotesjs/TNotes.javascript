...
- [8. 🤔 ReadableStream 是什么？](#8--readablestream-是什么)
- [9. 💻 demos.1 - 简单的生成数字流示例](#9--demos1---简单的生成数字流示例)
- [10. 💻 demos.3 - 流式读取文本文件数据示例](#10--demos3---流式读取文本文件数据示例)
- [11. 💻 demos.2 - `response.body` 分流 `tee()` 处理示例](#11--demos2---responsebody-分流-tee-处理示例)
- [12. 💻 demos.4 - 错误处理](#12--demos4---错误处理)
- [13. 🔗 引用](#13--引用)
...
## 11. 💻 demos.2 - `response.body` 分流 `tee()` 处理示例

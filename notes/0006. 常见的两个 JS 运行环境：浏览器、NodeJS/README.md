...
- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. 用浏览器来执行 JS 程序的基本流程](#3-用浏览器来执行-js-程序的基本流程)
  - [3.1. 如何打开 Chrome 控制台？](#31-如何打开-chrome-控制台)
  - [3.2. 自测练习](#32-自测练习)
...
你可以将下面的程序复制到“控制台”，按下回车后，就可以看到运行结果。
...
::: warning 补充：关于 chrome 控制台禁止粘贴的问题

![img](https://cdn.jsdelivr.net/gh/tnotesjs/imgs@main/2025-08-19-16-43-31.png)
